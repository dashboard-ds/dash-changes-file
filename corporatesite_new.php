...
//---------------get list of all bench marking projects--------------------
        ...
        mysqli_select_db($conn,$dbname);
		 if($typeofuser =='admin')
		 {
		 $sql =  "SELECT r.rid,r.type,r.title,r.reporttag,r.referenceno,r.pono,r.creationtime,r.uploadedby FROM reports r where r.type = 'Bench Marking'";	 
		 }
		 else
		 {	 
		 $sql =  "SELECT r.rid,r.type,r.title,r.reporttag,r.referenceno,r.pono,r.creationtime,r.uploadedby FROM reports r,reportallocation allo where r.rid=allo.rid && allo.email='".$_SESSION["clientemail"]."' && r.type = 'Bench Marking'";
		 }
		 $result = mysqli_query($conn, $sql);
		 $num = mysqli_num_rows($result);
...
<g>
 ...
 <!-- <div class='header'><button  class='actionbtn'  style='float:right;'><a target='_blank' id='exportbtn' href='exportresultset.php?reportid=<?php echo$_GET["reportid"]?>' title='Export Resultset In Excel Sheet'>Export</a></button><button title='Show result set' class='actionbtn' id='bcktolst' style='float:right;'>Result set</button><button title='show/hide filters' class='actionbtn filter-area-not-expanded' id='showfilters' style='float:right;'>Filters</button><button title='show/hide comments' class='actionbtn comment-area-not-expanded' id='showcomments' style='float:right;'>Comments</button><button title='show insights' class='actionbtn' id='showinsights' style='float:right;'>Insights</button></div>-->
  ...
  <div class='filter-card-wd-100'><form id='filtersformcriteria'>Criteria <select name='corporatecriteria' id='corporatecriteria'><option value=''>--Select--</option><option value='activeauthority'>Active In</option><option value='family'>Filed In</option></select> Country Code <select name='criteriacc' id='criteriacc'><option value=''>--Select--</option><option>CN</option><option>JP</option><option>US</option><option>DE</option><option>FR</option><option>KR</option><option>GB</option></select><div id="insight-result-count-clickedpoint"></form></div></div>
					...
					function corporateinsights()
					{
                       ...
                       $('#chart-6').html("<div id='processing-div-6'>We are processing your request.... <img src='images/process.gif'/></div>");					   
						$.ajax({
                           type: "POST",
                           url: "retrievetext.php",
                           data: fd+"&action=getinsight&reportid="+reportid+"&chart=44&topvalue=20&corporatecriteria="+corporatecriteria+"&criteriacc="+criteriacc,
                           timeout: 600000,
						   dataType: "json",
						   success: function (data) 
						   {
							    ...
							    if(data!=0)
								  {
									  ...
									  for (i = 0; i < data.length; i++) 
								      {
										  ...
										  y.push(data[i].score);
											...
											globaly  = y;
											globalz = z;
											var globalmetadata ={'drilldown':'enable','x':'assignee','y':'indexscore'};
					  ...
					  $.ajax({
                           type: "POST",
                           url: "retrievetext.php",
                           data: fd+"&action=getinsight&reportid="+reportid+"&chart=45&topvalue=20&corporatecriteria="+corporatecriteria+"&criteriacc="+criteriacc,
                           timeout: 600000,
						   dataType: "json",
						   success: function (data) 
						   {
							    ...
							    if(data!=0)
								  {
									  ...
									  for (i = 0; i < data.length; i++) 
								      {
										  ...
										  y.push(data[i].score);
											...
											globaly  = y;
											globalz = z;
											var globalmetadata ={'drilldown':'enable','x':'assignee','y':'mcscore'};
	                   ...
	                   $.ajax({
                           type: "POST",
                           url: "retrievetext.php",
                           data: fd+"&action=getinsight&reportid="+reportid+"&chart=4&topvalue=20&corporatecriteria="+corporatecriteria+"&criteriacc="+criteriacc,
                           timeout: 600000,
						   dataType: "json",
						   success: function (data) 
						   {
                     ...
                     $.ajax({
                           type: "POST",
                           url: "retrievetext.php",
                           data: fd+"&action=getinsight&reportid="+reportid+"&chart=46&topvalue=20&corporatecriteria="+corporatecriteria+"&criteriacc="+criteriacc,
                           timeout: 600000,
						   dataType: "json",
						   success: function (data) 
						   {
							    ...
							    if(data!=0)
								  {
									  ...
									  for (i = 0; i < data.length; i++) 
								      {
										  ...
										  y.push(data[i].score);
											...
											globaly  = y;
											globalz = z;
											var globalmetadata ={'drilldown':'enable','x':'assignee','y':'eciscore'};
					  ...
					  $.ajax({
                           type: "POST",
                           url: "retrievetext.php",
                           data: fd+"&action=getinsight&reportid="+reportid+"&chart=47&topvalue=20&corporatecriteria="+corporatecriteria+"&criteriacc="+criteriacc,
                           timeout: 600000,
						   dataType: "json",
						   success: function (data) 
						   {
									 ...
									 for (i = 0; i < data.length; i++) 
								      {
										  ...
										  y.push(data[i].cc);
											...
											globaly  = y;
											globalz = z;
											var globalmetadata ={'drilldown':'enable','x':'assignee','y':'activecountry','xcol':'Assignee Name','ycol':'Count','zcol':'Active Country'};
					  ...
					  $.ajax({
                           type: "POST",
                           url: "retrievetext.php",
                           data: fd+"&action=getinsight&reportid="+reportid+"&chart=48&topvalue=20&corporatecriteria="+corporatecriteria+"&criteriacc="+criteriacc,
                           timeout: 600000,
						   dataType: "json",
						   success: function (data) 
						   {
