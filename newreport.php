	  ...
	  <form method='post' action='' id='myform'>
		...
		<section>
             ...
             <div class='col-md-6'>			
	           <div class='form-group'>
		            <label for='rtitle'>Title</label>
		                <input type='text' name='rtitle' class='form-control' id='rtitle' placeholder='Report title' required />
		        </div>
	            <div class='form-group'>
		          <label for='rtype'>Type of Report</label>
		             <select class='form-control' required name='rtype'>
					       <option>FTO</option>
						   <option>Landscape</option>
						   <option>Patent Citation</option>
						   <option>Benchmarking</option>
						   <option>Divisionsite</option>
					 </select>
		        </div>
				
				 <div class='form-group'>
		          <label for='tagging'>Tag report</label>
		             <select class='form-control' name='tagging' id='tagging'>
			...
			<div class='form-group'>
		             ...
		             <input type='text' name='referenceno' class='form-control' id='referenceno' required value="" placeholder='Reference no'/>
		    </div> 
			<div class='form-group'>
			     <label for='pono'>PO Number</label>
				 <input type='text' name='pono' class='form-control' id='pono' required value="" placeholder='PO Number.'/>
			</div>			
			</div>
	    </div>
		</section>
        ...
        <section>
			...
			<div class='row'>
             <div class='col-md-6'>			
	           <div class='form-group'>
		            <label for='rrelevancy'>Relevancy Column</label>
					<select class='form-control' required name='rrelevancy'>
	            ...
	            <div class='form-group'>
		          <label for='rscoring'>Scoring Columns(PatentSight)</label>
		             <select class='form-control' required name='rscoring'>
					       <option value='1'>Yes</option>
						   <option value='0'>NO</option>
					 </select>
		       </div>
			   ...
			   <div class='form-group'>
		          <label for='rfamilymemberslegalstatus'>Family Members legal Status</label>
		             <select class='form-control' required name='rfamilymemberslegalstatus'>
					       <option value='1'>Yes</option>
						   <option value='0'>NO</option>
					 </select>
		       </div>
			   ...
			   <div class='form-group'>
			     <label for='headquarter'>Assignee HeadQuarter</label>
				 <select class='form-control' required name='headquarter'>
					       <option value='1'>Yes</option>
						   <option value='0'>NO</option>
				 </select>
			...
			<div class='col-md-6'>
			<div class='form-group'>
		              <label for='rcategorization'>Categorization</label>
					  <select class='form-control' required name='rcategorization'>
					       <option value='1'>Yes</option>
						   <option value='0'>NO</option>
					 </select>
			...
			<div class='form-group'>
			     <label for='typeofassignee'>Type of Assignee</label>
				 <select class='form-control' required name='typeofassignee'>
					       <option value='1'>Yes</option>
						   <option value='0'>NO</option>
				 </select>
            ...
            <div class='form-group'>
			     <label for='ipccpc'>IPC & CPC column</label>
				 <select class='form-control' required name='ipccpc'>
					       <option value='1'>Yes</option>
						   <option value='0'>NO</option>
				 </select>
             ...
             <div class='form-group'>
			     <label for='ipccpc'>PDF</label>
				 <select class='form-control' required name='pdf'>
					       <option value='1'>Yes</option>
						   <option value='0'>NO</option>
				 </select>
		...
		<div class='nxtrow' style='text-align:center'>
		    <a class='button button1' href='allfiles.php'>Cancel</a>
                                ...
                                success: function(data)
			                     {
									 ...
									 if(data[0].id!='')
									 {
									  window.location.href="uploadcsv.php?reportid="+data[0].id;
