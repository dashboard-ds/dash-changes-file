...
<?php
  ...
  <div class='header'><button  class='actionbtn'  style='float:right;'><a target='_blank' id='exportbtn' href='exportpatentminingdata.php?reportid=<?php echo$_GET["reportid"]?>' title='Export Resultset In Excel Sheet'>Export</a></button><button title='show/hide filters' class='actionbtn filter-area-not-expanded' id='showfilters' style='float:right;'>Filters</button><button  class='actionbtn'  style='float:right;'><a id='showoverallinsights' title='A bird eye view of quick insights' target='_blank' href='patentmininginsights.php?reportid=<?php echo$_GET["reportid"]?>' title=''>Insight Synopsis</a></button></div>
