		...
		$.ajax({
	                 ...
	                 $.ajax({
							    ...
							    if(data!=0)
								  {
									  ...
									  for (i = 0; i < data.length; i++) 
								      {
										 ...
										 changecharttype('hbar','Patent portfolio size','chart-1');
						...
						$.ajax({
                           type: "POST",
                           url: "retrievetext.php",
                           data: fd+"&action=getinsight&reportid="+reportid+"&chart=47&topvalue=10",
                           timeout: 600000,
						   dataType: "json",
						   success: function (data) 
						   {
									 ...
									 for (i = 0; i < data.length; i++) 
								      {
										  ...
										  y.push(data[i].cc);
											...
											globaly  = y;
											globalz = z;
											globalmetadata ={'drilldown':'enable','x':'assignee','y':'activecountry','xcol':'Assignee Name','ycol':'Market Country','zcol':'Count'};
											
											
										changecharttype('h3Dbar','Patent portfolio size by country','chart-2');
					  ...
					  $.ajax({
                           type: "POST",
                           url: "retrievetext.php",
                           data: fd+"&action=getinsight&reportid="+reportid+"&chart=44&topvalue=10",
                           timeout: 600000,
						   dataType: "json",
						   success: function (data) 
						   {
							    ...
							    if(data!=0)
								  {
									  ...
									  for (i = 0; i < data.length; i++) 
								      {
										 ...
										 changecharttype('hbar','Patent Portfolio Asset Value','chart-3');
					  ...
					  $.ajax({
                           type: "POST",
                           url: "retrievetext.php",
                           data: fd+"&action=getinsight&reportid="+reportid+"&chart=45&topvalue=10",
                           timeout: 600000,
						   dataType: "json",
						   success: function (data) 
						   {
							    $('#insightdescription').html("This chart illustrates the dominant companies according to mcscore.");
							    $('#processing-div').remove();
							    if(data!=0)
								  {
									  exportdata = data;
									  ...
									  for (i = 0; i < data.length; i++) 
								      {
										 ...
										 changecharttype('hbar','Market Coverage','chart-4');
					  ...
					  $.ajax({
                           type: "POST",
                           url: "retrievetext.php",
                           data: fd+"&action=getinsight&reportid="+reportid+"&chart=49&topvalue=10",
                           timeout: 600000,
						   dataType: "json",
						   success: function (data) 
						   {
							    $('#insightdescription').html("This chart illustrates the dominant companies according to etrscore.");
							    $('#processing-div').remove();
							    if(data!=0)
								  {
									  exportdata = data;
									  ...
									  for (i = 0; i < data.length; i++) 
								      {
										 ...
										 changecharttype('hbar','External Technology Relevance','chart-5');
					  ...
					  $.ajax({
                           type: "POST",
                           url: "retrievetext.php",
                           data: fd+"&action=getinsight&reportid="+reportid+"&chart=46&topvalue=10",
                           timeout: 600000,
						   dataType: "json",
						   success: function (data) 
						   {
							    $('#insightdescription').html("This chart illustrates the dominant companies according to eciscore.");
							    $('#processing-div').remove();
							    if(data!=0)
								  {
									  exportdata = data;
									  ...
									  for (i = 0; i < data.length; i++) 
								      {
										 ...
										 changecharttype('hbar','ECI','chart-6');
...
function changecharttype(charttype,charttitle,chartposid)
	   {
		            $('#insight-result-count-clickedpoint').html('');
