...
if($_GET['action'] =='showdata')
{
	...
	if(count($myCondition) > 0)
		 ...
		 $sql =  "SELECT r.rid,r.pubno,r.pubtitle,r.appdate,r.pdate,r.pubdate,r.parentassignee,r.updateddate,r.relevancy,r.relevantpatent_legalstatus,r.tagging from relevantpatents r left join categorization c on r.rid=c.rid && r.pubno=c.pubno ".$myCondition." group by r.pubno"; 
		 //echo $sql;
