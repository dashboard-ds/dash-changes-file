...
<?php
 ...
 <!-- <div class='header'><button  class='actionbtn'  style='float:right;'><a target='_blank' id='exportbtn' href='exportresultset.php?reportid=<?php echo$_GET["reportid"]?>' title='Export Resultset In Excel Sheet'>Export</a></button><button title='Show result set' class='actionbtn' id='bcktolst' style='float:right;'>Result set</button><button title='show/hide filters' class='actionbtn filter-area-not-expanded' id='showfilters' style='float:right;'>Filters</button><button title='show/hide comments' class='actionbtn comment-area-not-expanded' id='showcomments' style='float:right;'>Comments</button><button title='show insights' class='actionbtn' id='showinsights' style='float:right;'>Insights</button></div>-->
  ...
  <div class='site-header'>Insight Overview </div>
  ...
  <div class='insight-card'><div class='insight-card-inner' id='chart-5'></div></div>
  <div class='insight-card'><div class='insight-card-inner' id='chart-6'></div></div>
	...
	$("#level3").on('change',function(){
		...
		$.ajax({
						...
						$.ajax({
                           type: "POST",
                           url: "retrievetext.php",
                           data: fd+"&action=getinsight&reportid="+reportid+"&chart=3&pdateopt=10",
                           timeout: 600000,
						   dataType: "json",
						   success: function (data) 
						   {
							   ...
							   if(data!=0)
								  {
									  ...
									  for (i = 0; i < data.length; i++) 
								      {
										  ...
										  y.push(data[i].count);
											...
											globaly  = y;
											globalz = z;
											var globalmetadata ={'drilldown':'enable','x':'pdate','y':'count'};	
											
										   changecharttype('line','Overall filing trend','chart-1',globalmetadata);
					  ...
					  $.ajax({
                           type: "POST",
                           url: "retrievetext.php",
                           data: fd+"&action=getinsight&reportid="+reportid+"&chart=8&pdateopt=10",
                           timeout: 600000,
						   dataType: "json",
						   success: function (data) 
						   {
									 ...
									 for (i = 0; i < data.length; i++) 
								      {
										  ...
										  z.push(data[i].z);
											...
											globaly  = y;
											globalz = z;
											var globalmetadata ={'drilldown':'enable','x':'pdate','y':'innovationcountry'};	
											
											
										changecharttype('bubble','Patent filings among various innovative countries','chart-5',globalmetadata);
	                   ...
	                   $.ajax({
                           type: "POST",
                           url: "retrievetext.php",
                           data: fd+"&action=getinsight&reportid="+reportid+"&chart=4&topvalue=10",
                           timeout: 600000,
						   dataType: "json",
						   success: function (data) 
						   {
							    ...
							    if(data!=0)
								  {
									  ...
									  for (i = 0; i < data.length; i++) 
								      {
										 ...
										 changecharttype('hbar','Top ten companies','chart-2',globalmetadata);
                      ...
                      $.ajax({
                           type: "POST",
                           url: "retrievetext.php",
                           data: fd+"&action=getinsight&reportid="+reportid+"&chart=7",
                           timeout: 600000,
						   dataType: "json",
						   success: function (data) 
						   {
							 	 ...
							 	 if(data!=0)
								  {
									  ...
									  for (i = 0; i < data.length; i++) 
								      {
										  ...
										  y.push(data[i].count);
											...
											globaly  = y;
											globalz = z;
											var globalmetadata ={'drilldown':'enable','x':'innovationcountry','y':'count'};	
											
											
												changecharttype('bar','Innovation Countries','chart-3',globalmetadata);
					  ...
					  $.ajax({
                           type: "POST",
                           url: "retrievetext.php",
                           data: fd+"&action=getinsight&reportid="+reportid+"&chart=6",
                           timeout: 600000,
						   dataType: "json",
						   success: function (data) 
						   {
							    ...
							    $('#processing-div').remove();
							 	 if(data!=0)
								  {
									  ...
									  $.each(data, function(key, value)
									  {
											...
											globaly  = y;
											globalz = z;
											var globalmetadata ={'drilldown':'enable','x':'marketcountry','y':'count'};	
											
											
										changecharttype('bar','Prefered market countries','chart-4',globalmetadata);
					  ...
					  $.ajax({
                           type: "POST",
                           url: "retrievetext.php",
                           data: fd+"&action=getinsight&reportid="+reportid+"&chart=21",
                           timeout: 600000,
						   dataType: "json",
						   success: function (data) 
						   {
							    ...
							    if(data!=0)
								  {
									  ...
									  for (i = 0; i < data.length; i++) 
								      {
										  ...
										  y.push(data[i].count);
											...
											globaly  = y;
											globalz = z;
											var globalmetadata ={'drilldown':'enable','x':'overalllegalstatus','y':'count'};
											
										changecharttype('pie','Legal Status Overall Families','chart-6',globalmetadata);
